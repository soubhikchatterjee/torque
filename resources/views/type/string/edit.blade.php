	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="{{ url('/string/edit') }}">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel2">{{ trans('type/string.edit_title') }}</h4>
					</div>
					<div class="modal-body">
						...
						<label class="control-label col-md-3 col-lg-3 col-xs-12" for="first-name">{{ trans('main.value') }} <span class="required">*</span>
							...
							<div class="col-md-6 col-lg-6 col-xs-12">
								<textarea id="txt_value" class="form-control" name="txt_value" data-parsley-minlength="1" data-parsley-validation-threshold="0" data-parsley-id="40" style="height: 150px;" tabindex="1">{{ $data }}</textarea>          
							</div>
						</div>
					</div>

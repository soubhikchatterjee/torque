	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="{{ url('/hash/edit') }}">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel2">{{ trans('type/hash.edit_title') }}</h4>
					</div>
					<div class="modal-body">
						...
						<label class="control-label col-md-3 col-lg-3 col-xs-12" for="txt_hash_key">{{ trans('type/hash.hash_key') }} <span class="required">*</span>
							...
							<div class="col-md-6 col-lg-6 col-xs-12">
								<input type="text" id="txt_hash_key" name="txt_hash_key" required="required" class="form-control col-md-7 col-xs-12" tabindex="1" value="{{ $hash_key }}">          
							</div>
						</div>					
						<div class="form-group">

<div class="modal fade set-delete" role="dialog" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">

      <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="{{ url('/set/delete') }}">
        ...
        <div class="modal-footer">
          ...
          <input type="hidden" id="_set_key" name="_set_key" value="">   

<div class="modal fade key-delete" role="dialog" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">

      <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="{{ url('/delete') }}">
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="col-md-12 col-lg-12 col-xs-12">
              <h2 id="head_delete">{{ trans('main.delete_key_description') }}</h2> 
            </div>
          </div>
        </div>
